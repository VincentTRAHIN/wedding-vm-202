<script lang="ts">
	...
	const wazeLink = 'https://waze.com/ul?ll=47.0919227,-0.4502939&navigate=yes';
	const mapsLink =
		'https://www.google.com/maps/search/?api=1&query=Château+des+Landes+49560+Cléré-sur-Layon';
	const embedLink =
